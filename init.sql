...
INSERT INTO StudentCourses (personal_id, course_id)  VALUES (1, 1);
INSERT INTO StudentCourses (personal_id, course_id)  VALUES (1, 2);
INSERT INTO StudentCourses (personal_id, course_id)  VALUES (2, 1);
INSERT INTO StudentCourses (personal_id, course_id)  VALUES (3, 3);
SELECT student.* FROM StudentCourses as r INNER JOIN Students as student ON student.id = r.personal_id WHERE r.course_id = 2 GROUP BY student.id;
SELECT course.*, dependant.* FROM StudentCourses AS r INNER JOIN  Courses as course ON course.id = r.course_id LEFT JOIN Courses as dependant ON course.depends_on = dependant.id WHERE r.personal_id = 1